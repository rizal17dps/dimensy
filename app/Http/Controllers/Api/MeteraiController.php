            ...
            if(!$cekToken){
                ...
                if($user){
                    $request->validate([
                        ...
                        'content.signer.*.lowerLeftX' => 'required|numeric',
                        'content.signer.*.lowerLeftY' => 'required|numeric',
                        'content.signer.*.upperRightX' => 'required|numeric',
                        'content.signer.*.upperRightY' => 'required|numeric',
